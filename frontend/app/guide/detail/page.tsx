...
const SECTIONS: Section[] = [
  ...
  },
  {
    id: "workflow-detail",
    icon: "▶",
    title: "매수 체크 심화 — 12개 조건의 의미",
    subtitle: "티커 입력 한 번으로 10개가 자동 판정되는 최종 관문",
    content: (
      <>
        <P>
          매수 체크 탭에 티커를 입력하면 12개 조건 중 <Highlight>10개를 실시간 데이터로 자동 판정</Highlight>합니다.
        ...
        {[
          {
            ...
            detail: "게이트 GO · 체제 Risk-on/Neutral · 리스크 허용 범위. 시장 자체가 나쁘면 종목이 좋아도 여기서 걸립니다.",
            go: "시장이 허락하는가",
          },
          {
    ...
    content: (
      <>
        ...
        <P>
          ...
          6개월 내 촉매가 있는지, 스토리가 깨지는 조건을 아는지, 관심도가 상승 중인지, 오늘 종목 분석에도 등장하는지.
          시스템이 자동으로 판정할 수 없는 <Highlight>정성적 판단</Highlight>만 모아뒀습니다 — 재무 필터·적합 점수처럼
          숫자로 이미 검증된 항목은 여기 다시 넣지 않았습니다.
        </P>
        <Note>
        ...
        {[
          {
            ...
            a: "체제는 환경 판단일 뿐입니다. 게이트 신호, 스크리닝 결과, 리스크 지표를 함께 확인해야 합니다. 매수 체크 탭의 12개 조건을 모두 통과한 후 매수하세요.",
            type: "warn",
          },
          {
            q: "AI 목표주가를 그대로 믿는다",
          ...
          },
          {
            ...
            a: "매수 체크에서 '워치리스트 후보 포함' 항목이 미통과로 뜹니다. 함정 필터에 걸렸거나(재무 위험) 적합 점수 상위 50 밖이라는 뜻이니, 워치리스트 탭에서 이유를 확인하고 그래도 사겠다면 근거를 워치리스트 팝업의 메모에 남기세요.",
            type: "danger",
          },
          {
